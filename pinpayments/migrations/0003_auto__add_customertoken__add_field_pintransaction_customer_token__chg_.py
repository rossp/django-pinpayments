...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PinTransaction.customer_token'
        db.add_column(u'pinpayments_pintransaction', 'customer_token',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PinTransaction.card_token'
        db.alter_column(u'pinpayments_pintransaction', 'card_token', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

    def backwards(self, orm):
        # Deleting model 'CustomerToken'
        db.delete_table(u'pinpayments_customertoken')

        # Deleting field 'PinTransaction.customer_token'
        db.delete_column(u'pinpayments_pintransaction', 'customer_token')


        # User chose to not deal with backwards NULL issues for 'PinTransaction.card_token'
        raise RuntimeError("Cannot reverse this migration. 'PinTransaction.card_token' and its values cannot be restored.")
    ...
    models = {
        ...
        u'pinpayments.pintransaction': {
            ...
            'customer_token': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
